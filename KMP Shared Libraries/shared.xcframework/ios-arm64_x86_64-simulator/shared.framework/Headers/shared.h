...
@protocol SharedErrorType
@required
@end

__attribute__((swift_name("ItemsApi")))
@protocol SharedItemsApi
@required
...
*/
- (void)getItemsWithCompletionHandler:(void (^)(id<SharedResponse> _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("getItems(completionHandler:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ItemsApiImpl")))
@interface SharedItemsApiImpl : SharedBase <SharedItemsApi>
- (instancetype)initWithNetworkClient:(id<SharedNetworkClient>)networkClient __attribute__((swift_name("init(networkClient:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedItemsApiImplCompanion *companion __attribute__((swift_name("companion")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ItemsApiImpl.Companion")))
@interface SharedItemsApiImplCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedItemsApiImplCompanion *shared __attribute__((swift_name("shared")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ItemDto")))
@interface SharedItemDto : SharedBase
- (instancetype)initWithId:(SharedInt * _Nullable)id listId:(SharedInt * _Nullable)listId name:(NSString * _Nullable)name __attribute__((swift_name("init(id:listId:name:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedItemDtoCompanion *companion __attribute__((swift_name("companion")));
- (SharedItemDto *)doCopyId:(SharedInt * _Nullable)id listId:(SharedInt * _Nullable)listId name:(NSString * _Nullable)name __attribute__((swift_name("doCopy(id:listId:name:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) SharedInt * _Nullable id __attribute__((swift_name("id")));
@property (readonly) SharedInt * _Nullable listId __attribute__((swift_name("listId")));
@property (readonly) NSString * _Nullable name __attribute__((swift_name("name")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ItemDto.Companion")))
@interface SharedItemDtoCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedItemDtoCompanion *shared __attribute__((swift_name("shared")));
...
- (SharedKtor_client_coreHttpClient *)createEngine:(id<SharedKtor_client_coreHttpClientEngine>)engine __attribute__((swift_name("create(engine:)")));
@end
...
@interface SharedNetworkError : SharedKotlinEnum<SharedNetworkError *> <SharedErrorType>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
...
@property (class, readonly) SharedNetworkError *forbidden __attribute__((swift_name("forbidden")));
...
@protocol SharedResponse
@required
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ResponseFailure")))
@interface SharedResponseFailure<__covariant E> : SharedBase <SharedResponse>
- (instancetype)initWithError:(E)error __attribute__((swift_name("init(error:)"))) __attribute__((objc_designated_initializer));
- (SharedResponseFailure<E> *)doCopyError:(E)error __attribute__((swift_name("doCopy(error:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
@interface SharedResponseSuccess<__covariant D> : SharedBase <SharedResponse>
- (instancetype)initWithData:(D _Nullable)data __attribute__((swift_name("init(data:)"))) __attribute__((objc_designated_initializer));
- (SharedResponseSuccess<D> *)doCopyData:(D _Nullable)data __attribute__((swift_name("doCopy(data:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
- (SharedItemRepositoryWrapper *)getItemRepositoryWrapper __attribute__((swift_name("getItemRepositoryWrapper()")));
- (void)doInitKoinAppModules:(NSArray<SharedKoin_coreModule *> *)appModules config:(void (^ _Nullable)(SharedKoin_coreKoinApplication *))config __attribute__((swift_name("doInitKoin(appModules:config:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ItemListMapper")))
@interface SharedItemListMapper : SharedBase
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (NSArray<SharedItem *> * _Nullable)toItemListItemDtoList:(NSArray<id> * _Nullable)itemDtoList __attribute__((swift_name("toItemList(itemDtoList:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Item")))
@interface SharedItem : SharedBase
- (instancetype)initWithId:(int32_t)id listId:(int32_t)listId name:(NSString *)name __attribute__((swift_name("init(id:listId:name:)"))) __attribute__((objc_designated_initializer));
- (SharedItem *)doCopyId:(int32_t)id listId:(int32_t)listId name:(NSString *)name __attribute__((swift_name("doCopy(id:listId:name:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) int32_t id __attribute__((swift_name("id")));
@property (readonly) int32_t listId __attribute__((swift_name("listId")));
@property (readonly) NSString *name __attribute__((swift_name("name")));
@end

__attribute__((swift_name("ItemRepository")))
@protocol SharedItemRepository
@required
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)getAllItemsWithCompletionHandler:(void (^)(id _Nullable_result, NSError * _Nullable))completionHandler __attribute__((swift_name("getAllItems(completionHandler:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("DefaultItemRepository")))
@interface SharedDefaultItemRepository : SharedBase <SharedItemRepository>
- (instancetype)initWithApi:(id<SharedItemsApi>)api mapper:(SharedItemListMapper *)mapper __attribute__((swift_name("init(api:mapper:)"))) __attribute__((objc_designated_initializer));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ItemRepositoryWrapper")))
@interface SharedItemRepositoryWrapper : SharedBase
- (instancetype)initWithRepo:(id<SharedItemRepository>)repo __attribute__((swift_name("init(repo:)"))) __attribute__((objc_designated_initializer));
@end
...
@interface SharedIOSNetworkClient : SharedBase <SharedNetworkClient>
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
@property (readonly) SharedKtor_client_coreHttpClient *httpClient __attribute__((swift_name("httpClient")));
@end
...
@interface SharedItemRepositoryWrapper (Extensions)
- (SharedKotlinUnit *(^(^)(SharedKotlinUnit *(^)(NSDictionary<SharedInt *, NSArray<SharedItem *> *> *, SharedKotlinUnit *), SharedKotlinUnit *(^)(NSError *, SharedKotlinUnit *), SharedKotlinUnit *(^)(NSError *, SharedKotlinUnit *)))(void))getAllItems __attribute__((swift_name("getAllItems()")));
@end
